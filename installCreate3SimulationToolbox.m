function installCreate3SimulationToolbox(replaceExisting,skipAdmin)
...
%toolboxSupport  = 'Create3SimulationToolboxSupport'; 
toolboxExamples = 'Create3SimulationToolbox Example SCRIPTS';
toolboxName = 'Create3 Simulation Toolbox';
